...
class Order:
    def __init__(self, dict):
        if dict.get("id") is not None: self.__id = dict.get("id")
        if dict.get("customer_id") is not None: self.__customer_id = dict.get("customer_id")
        if dict.get("worker_id") is not None: self.__worker_id = dict.get("worker_id")
        if dict.get("status") is not None: self.__status = dict.get("status")
        if dict.get("description") is not None: self.__description = dict.get("description")
        if dict.get("created_at") is not None: self.__created_at = dict.get("created_at")
        if dict.get("finished_at") is not None: self.__finished_at = dict.get("finished_at")
